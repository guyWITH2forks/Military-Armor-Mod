...
public class HeavyPants extends ItemArmor implements IHasModel
{
	public HeavyPants(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
