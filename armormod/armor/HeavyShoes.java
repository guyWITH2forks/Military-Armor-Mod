...
public class HeavyShoes extends ItemArmor implements IHasModel
{
	public HeavyShoes(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
