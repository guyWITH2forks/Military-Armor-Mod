...
public class MediumPants extends ItemArmor implements IHasModel
{
	public MediumPants(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
