...
public class HeavyHelmetArctic extends ItemArmor implements IHasModel
{
	public HeavyHelmetArctic(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
