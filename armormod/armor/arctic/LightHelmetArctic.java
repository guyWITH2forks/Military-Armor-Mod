...
public class LightHelmetArctic extends ItemArmor implements IHasModel
{
	public LightHelmetArctic(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
