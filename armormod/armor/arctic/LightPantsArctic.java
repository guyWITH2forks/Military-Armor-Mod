...
public class LightPantsArctic extends ItemArmor implements IHasModel
{
	public LightPantsArctic(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
