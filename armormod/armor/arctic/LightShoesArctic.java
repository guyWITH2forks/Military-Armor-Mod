...
public class LightShoesArctic extends ItemArmor implements IHasModel
{
	public LightShoesArctic(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) 
	{
